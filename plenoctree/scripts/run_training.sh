...
# EDIT THESE PATHS
DATA_ROOT="/mnt/d/GitHub/nerf-projects/plenoctree/data/NeRF/nerf_synthetic"  # e.g., /mnt/d/data/NeRF/nerf_synthetic
CKPT_ROOT="/mnt/d/GitHub/nerf-projects/plenoctree/data/Plenoctree/checkpoints/syn_sh16"
SCENE="mic"
...
python -m nerf_sh.eval --chunk 4096 --train_dir "${CKPT_ROOT}/${SCENE}" --config "${CONFIG_FILE}" --data_dir "${DATA_ROOT}/${SCENE}"
